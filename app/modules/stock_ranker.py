...
# Comprehensive 155+ Stock Market Universe (Nifty 50, Next 50, Midcaps, Smallcaps & FO)
NIFTY50 = [
    "RELIANCE", "HDFCBANK", "ICICIBANK", "INFY", "TCS", "BHARTIARTL", "ITC",
    "SBIN", "LT", "KOTAKBANK", "AXISBANK", "HINDUNILVR", "BAJFINANCE", "ASIANPAINT",
    "MARUTI", "M&M", "HCLTECH", "SUNPHARMA", "TITAN", "ULTRACEMCO",
    ...
    "SHRIRAMFIN", "BPCL", "SUZLON", "IREDA", "JIOFIN", "PAYTM",
    "TATAPOWER", "TATAELXSI", "TATACHEM", "TATATECH", "TATACOMM", "TATAINVEST",
    "RVNL", "IRFC", "RAILTEL", "NHPC", "HAL", "BEL", "CDSL",
    "ANGELONE", "POLICYBZR", "MCX", "KALYANKJIL", "OLAELEC", "BHEL", "DLF",
    "GODREJPROP", "OBEROIRLTY", "PERSISTENT", "COFORGE", "MPHASIS", "TRENT",
    "VBL", "CHOLAFIN", "PFC", "RECLTD", "IOC", "GAIL", "SAIL", "NMDC",
    "VEDL", "AMBUJACEM", "ACC", "DALBHARAT", "INDIGO", "GMRAIRPORT", "IRCTC",
    "IDEA", "YESBANK", "IDFCFIRSTB", "FEDERALBNK", "AUBANK", "BANDHANBNK",
    "BANKBARODA", "CANBK", "PNB", "UNIONBANK", "OIL", "HINDPETRO",
    "MRF", "BALKRISIND", "APOLLOTYRE", "BOSCHLTD", "MOTHERSON",
    "DIXON", "KAYNES", "SYRMA", "POLYCAB", "KEI", "HAVELLS", "VOLTAS",
    "BLUESTARCO", "WHIRLPOOL", "CROMPTON", "ASTRAL", "SUPREMEIND", "PIDILITIND",
    "BERGEPAINT", "KANSAINER", "COLPAL", "DABUR", "MARICO", "GODREJCP",
    "GODREJIND", "EMAMILTD", "PATANJALI", "TORNTPHARM", "MANKIND", "LUPIN",
    "ZYDUSLIFE", "ALKEM", "AUROPHARMA", "GLENMARK", "BIOCON", "LAURUSLABS",
    "SYNGENE", "MAXHEALTH", "FORTIS", "MEDANTA", "METROPOLIS", "LALPATHLAB",
    "NAUKRI", "JUSTDIAL", "NYKAA", "DELHIVERY", "MAPMYINDIA", "AFFLE",
    "ROUTE", "TANLA", "KPITTECH", "HAPPSTMNDS", "SONACOMS"
]
