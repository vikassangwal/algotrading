...
sheet = wb.sheets['LTP']
# Credentials come from the environment (.env) — NEVER hardcode tokens here.
import os
...
if not client_id or not access_token:
    raise SystemExit("Set DHAN_CLIENT_ID and DHAN_ACCESS_TOKEN in .env before running this script.")
